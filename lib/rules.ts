// 투표 마감 규칙: 참석 인원이 30명이 차면 자동으로 마감한다. 운영진은
// 마감 후에도 예외적으로 투표를 대신 추가할 수 있다.
...
export function isVotingClosed(attendCount: number): boolean {
  return attendCount >= ATTEND_CAP;
}
